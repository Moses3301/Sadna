...
public class InProgressReviewsFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragView = inflater.inflate(R.layout.in_progress_reviews_frag,null);
    ...
    private void initRecyclerView() {
        AdminReportReviewsRecyclerAdapter adapter = new AdminReportReviewsRecyclerAdapter(mInProgressMenusProblems, getContext());
    ...
    {
        mInProgressMenusProblems.clear();
